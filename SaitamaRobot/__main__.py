...
Kawaki is hosted on one of MickeyxD's Servers and doesn't require any donations as of now but \
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                     ...
                     [
                         InlineKeyboardButton(
                             text="🗄 Source code",
                             url="https://github.com/MickeyxD/Kawaki")
                     ]]))
    else:
